...
def main():
    ...
    business_scenario = st.text_input("Enter the business scenario (e.g., Sales Forecasting, Customer Segmentation):")
    data_type = st.selectbox("Choose the type of data to generate:", ["Time Series", "Geomap", "Other (Pie, Bar, Scatter)", "Data Only"])
    num_rows = st.number_input("Enter the number of entries to generate:", min_value=1, step=1)
                ...
                if set(['Category', 'Value']).issubset(df.columns):
                    ...
                    if data_type == "Time Series":
                        ...
                        if visualization_type == "Pie":
                            fig = px.pie(df, names="Category", values="Value", title="Pie Chart")
                        elif visualization_type == "Bar":
                            fig = px.bar(df, x="Category", y="Value", title="Bar Chart")
                        elif visualization_type == "Scatter":
                            fig = px.scatter(df, x="Category", y="Value", title="Scatter Plot")
                        st.plotly_chart(fig)
